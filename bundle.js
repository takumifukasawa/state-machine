...
var StateMachine = function (_eventemitter) {
  ...
  function StateMachine(_ref) {
    var _ref$init = _ref.init,
        init = _ref$init === undefined ? undefined : _ref$init,
        events = _ref.events;
    ...
    _lodash2.default.forEach(_this._events, function (event) {
      ...
      _this.on(eventName, function () {
        _this.fireEvent(eventName, fromState, toState);
      });

      // イベントが開始されるとき用のlistener
      if (event.onBeforeEvent) {
        _this.on('onBefore' + eventName, event.onBeforeEvent);
      }

      // stateを離れる時用のlistener
      if (event.onLeaveState) {
        _this.on('onLeave' + fromState, event.onLeaveState);
      }

      // stateが切り替わる直前のlistener
      if (event.onEnterState) {
        _this.on('onEnter' + toState, event.onEnterState);
      }

      // event終了時のlistener
      if (event.onAfterEvent) {
        _this.on('onAfter' + eventName, event.onAfterEvent);
      }
    });
    return _this;
  }
  ...
  (0, _createClass3.default)(StateMachine, [{
    ...
    key: 'isCorrectFromState',
    value: function isCorrectFromState(fromState) {
      var _this2 = this;

      if (_lodash2.default.isArray(fromState)) {
        var hasState = _lodash2.default.find(fromState, function (state) {
          return _this2.checkState(state);
        });
        return hasState;
      } else {
    ...
    key: 'fireEvent',
    value: function fireEvent(eventName, fromState, toState) {
      var hasState = this.isCorrectFromState(fromState);
...
},{"babel-runtime/core-js/object/get-prototype-of":5,"babel-runtime/helpers/classCallCheck":9,"babel-runtime/helpers/createClass":10,"babel-runtime/helpers/inherits":11,"babel-runtime/helpers/possibleConstructorReturn":12,"eventemitter3":89,"lodash":91}],2:[function(require,module,exports){
'use strict';
...
var stateMachine = new _StateMachine2.default({
  ...
  events: [{
    ...
    onBeforeEvent: function onBeforeEvent() {
      return console.log('before page load event');
    }
  }, {
    eventName: EVENTS.LOADED_PAGE,
    fromState: STATES.LOADING,
    toState: STATES.SHOWING_PAGE,
    onAfterEvent: function onAfterEvent() {
      return console.log('after page loaded event');
    }
  }]
});
...
},{"./StateMachine":1,"keymirror":90}],3:[function(require,module,exports){
